...
<footer className="container mx-auto relative bg-blueGray-200 pt-8 pb-6 mt-10">
  <div className="container mx-auto px-4">
    <div className="flex flex-wrap text-left lg:text-left">
      <div className="flex md:flex-wrap w-full md:w-6/12 px-4">
        <img src={Logo} alt="logo" className="w-48 h-48"/>
        <div className=" mx-auto mt-6 lg:mb-0 mb-6 ">
